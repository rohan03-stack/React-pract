...
import tailwind from '../assets/image-portfolio-master/nodejs.png'
...
export default function Skills() {
  return (
    <section className='relative min-h-screen overflow-hidden flex flex-col items-center  justify-center text-white px-4 py-10'>
      ...
      <img src={imghero} alt="left picture" className='absolute z-30 left-2 top-2 sm:left-16 sm:top-32 transform -rotate-12 w-24 h-auto sm:w-32 opacity-70 ' />
  ...
  <section data-aos='fade-up' data-aos-delay='500' className='grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-35'>
{skillsData.map((skills) => (
  <SkillsBox key={skills.id} image={skills.image} title={skills.title} description={skills.description} />
))}
  </section>
      </div>
      <img src={imghero} alt="Right Picture" className='absolute z-30 right-2   sm:right-16 sm:top-32 transform rotate-12 w-24 h-auto sm:w-32 opacity-70' />
    </section>
  )
}
